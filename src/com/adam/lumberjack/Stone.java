...
public class Stone extends GameObject {
    ...
    public Stone(World world, float x, float y, TextureRegion texture, float widthRatio, float heightRatio, Hitbox hitbox, int maxHealth, int loot, Chunk ownerChunk) {
    ...
    protected void createBody(World world, float x, float y) {
        ...
        fixtureDef.filter.categoryBits = ObjectCategory.STONE.getValue();
