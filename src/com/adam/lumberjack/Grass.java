...
public class Grass extends GameObject {
    ...
    public Grass(World world, float x, float y, TextureRegion texture, float widthRatio, float heightRatio, Hitbox hitbox, int maxHealth, int loot, Chunk ownerChunk) {
